...
import { StyleSheet, Text, View, SafeAreaView, Platform, StatusBar, Image, Switch, TouchableOpacity } from "react-native";
        ...
        <View style={this.state.lightTheme?styles.containerLight:styles.container}>
          ...
          <View style={styles.appTitle}>
            ...
            <View style={styles.appTitleTextContainer}>
              <Text style={this.state.lightTheme?styles.appTitleLight:styles.appTitleText}>Spectagram App</Text>
            </View>
          </View>
          <View style={styles.screenContainer}>
            ...
            <View style={styles.themeContainer}>
              <Text style={this.state.lightTheme?styles.themeTextLight:styles.themeText}>{this.state.lightTheme?"Light Theme":"Dark Theme"}</Text>
              <Switch
                style={{
